...
for K in K_NUMBER:
        ...
        while increased <= patience:
            ...
            if iteration == 1 or iteration%val_every == 0:
                ...
                if iteration == 1 or val_loss < best_val_loss:
                    ...
                    best_model = model
                    model_name = 'model_nn_K' + str(K) + '_whole_param'
                    torch.save(model, model_name)
                    increased = 0
                else:
                    increased = increased + 1

    results = "results_nn_K" + str(K) + "_whole_param"
    file = open(results, "w")
    print("DONE TRAINING")
    ...
    ax.legend(loc='best')
    # plt.show(block=True)
    plot_name = 'lost_history_nn_K' + str(K) + '_whole_param.png'
    ...
    plt.colorbar()
    # plt.show(block=True)
    plot_name = 'depth_plot_nn_one_K' + str(K) + '_whole_param.png'
    plt.savefig(plot_name)
    ...
    plt.colorbar()
    # plt.show(block=True)
    plot_name = 'depth_plot_nn_two_K' + str(K) + '_whole_param.png'
    plt.savefig(plot_name)
    ...
    name = 'coding_functions_nn_K' + str(K) + '_whole_param.npz'
